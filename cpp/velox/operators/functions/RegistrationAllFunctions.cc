...
#include "operators/functions/SchemaOfJson.h"
...
void registerFunctionOverwrite() {
  ...
  // Register schema_of_json function.
  facebook::velox::registerFunction<SchemaOfJsonFunction, facebook::velox::Varchar, facebook::velox::Varchar>(
      {"schema_of_json"});
}
