...
#include "operators/functions/Levenshtein.h"
...
void registerFunctionOverwrite() {
  ...
  velox::registerFunction<LevenshteinFunction, int32_t, velox::Varchar, velox::Varchar>({"levenshtein"});
  velox::registerFunction<LevenshteinFunction, int32_t, velox::Varchar, velox::Varchar, int32_t>({"levenshtein"});
